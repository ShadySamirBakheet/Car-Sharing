package shady.samir.carsharing.views.profile
...
import shady.samir.carsharing.databinding.ActivityProfileBinding
...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun setHaveCar(bool:Boolean){
        if (bool){
            carOwner = true

            binding.yes.setBackgroundResource( R.drawable.check1)
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                binding.yes.setTextColor(getColor(R.color.txtColor2))
            }

            binding.no.setBackgroundResource( R.drawable.check2)
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                binding.no.setTextColor(getColor(R.color.txtColor1))
            }
        }else{
            carOwner = false
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                binding.yes.setTextColor(getColor(R.color.txtColor1))
            }

            binding.no.setBackgroundResource( R.drawable.check1)
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                binding.no.setTextColor(getColor(R.color.txtColor2))
            }}
    }
